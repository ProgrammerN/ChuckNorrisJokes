 ...
 */
@AndroidEntryPoint
class CategoriesFragment : Fragment(R.layout.fragment_categories), JokeCategoryAdapter.OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val jokeCategoryAdapter = JokeCategoryAdapter(this)

        binding.apply {
            recyclerViewCategories.apply {
                adapter = jokeCategoryAdapter
            ...
            viewModel.categories.observe(viewLifecycleOwner) { categories ->
                ...
                jokeCategoryAdapter.submitList(categories.data)
